...
export const INSTAGRAM_POSTS: InstagramPost[] = [
  {
    ...
    image: '/photos/instagram-muay-thai-panorama.png',
  ...
  },
  {
    ...
    image: '/photos/instagram-ncc-sea-highlights.png',
  ...
  },
  {
    ...
    image: '/photos/instagram-stp-trainers-programme.png',
    aspectRatio: 'portrait',
...
export const EdzInstagramView: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto text-[#666666] space-y-12">
      ...
      <header className="pb-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
        <div>
